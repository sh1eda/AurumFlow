    ...
    df = pd.DataFrame(
        {
            ...
            "open": [100, 103, 103, 102, 100, 99, 101, 104, 103, 103, 106],
            "high": [101, 105, 104, 103, 102, 101, 107, 125, 104, 105, 108],
            "low": [99, 100, 101, 98, 99, 97, 100, 103, 102, 102, 106],
            "close": [100, 104, 102, 99, 101, 100, 106, 104, 103, 104, 107],
            "volume": [1] * 11,
        }
    )
